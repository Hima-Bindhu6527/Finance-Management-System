  ...
  const handleGenerateReport = async () => {
    try {
      ...
      if (!contentType || !contentType.includes("application/json")) {
        ...
        alert(
          "Server error: Expected JSON response but got HTML. Check backend logs."
        );
        return;
      }
        ...
        return (
          <div className="overview-container">
            <div className="overview-header">
              ...
              <p>
                Generate comprehensive financial reports and track your
                financial health
              </p>
            </div>
            ...
            <div className="overview-cards">
              <div className="overview-card">
                ...
                <p>
                  Create detailed financial analysis reports with insights and
                  recommendations
                </p>
                <button
              ...
              <div className="overview-card">
                ...
                <h3>View Reports</h3>
                <p>
                  Access your historical reports and track financial progress
                  over time
                </p>
                <button
                  className="card-button"
            ...
            {reports.length > 0 && (
              <div className="quick-stats">
                ...
                <div className="stat-item">
                  ...
                  <span
                    className={`stat-number ${getHealthScoreColor(
                      reports[0]?.reportData?.healthIndicators
                        ?.financialHealthScore
                    )}`}
                  >
                    {reports[0]?.reportData?.healthIndicators?.financialHealthScore?.toFixed(
                      0
                    ) || "N/A"}
                    /100
                  </span>
                ...
                <div className="stat-item">
                  ...
                  <span className="stat-number">
                    {formatCurrency(reports[0]?.reportData?.summary?.netWorth)}
                  </span>
                </div>
              </div>
            )}
                      ...
                      <div className="health-score-mini">
                        ...
                        <strong
                          className={getHealthScoreColor(
                            report.reportData?.healthIndicators
                              ?.financialHealthScore
                          )}
                        >
                          {report.reportData?.healthIndicators?.financialHealthScore?.toFixed(
                            0
                          ) || "N/A"}
                          /100
                        </strong>
        ...
        return (
          <div className="generate-report-container">
            ...
            <p className="subtitle">
              Create a comprehensive analysis based on your goals, income,
              expenses, and assets
            </p>
                    ...
                    <div className="report-stats">
                      <div className="stat">
                        ...
                        <span className="stat-value">
                          {formatCurrency(report.reportData?.summary?.netWorth)}
                        </span>
                      </div>
                      <div className="stat">
                        <span className="stat-label">Health Score</span>
                        <span
                          className={`stat-value ${getHealthScoreColor(
                            report.reportData?.healthIndicators
                              ?.financialHealthScore
                          )}`}
                        >
          ...
          <div className="report-details-container">
            ...
            <div className="report-sections">
                ...
                <div className="summary-grid">
                  ...
                  <div className="summary-item">
                    ...
                    <span
                      className={`summary-value ${
                        reportData.summary?.monthlySavings >= 0
                          ? "positive"
                          : "negative"
                      }`}
                    >
                  ...
                  <div className="summary-item">
                    ...
                    <span className="summary-value">
                      {formatPercentage(reportData.summary?.savingsRate)}
                    </span>
                  </div>
                  <div className="summary-item">
                    <span className="summary-label">Total Assets</span>
                    <span className="summary-value positive">
                      {formatCurrency(reportData.summary?.totalAssets)}
                    </span>
                  </div>
                  <div className="summary-item">
                    <span className="summary-label">Total Liabilities</span>
                    <span className="summary-value negative">
                      {formatCurrency(reportData.summary?.totalLiabilities)}
                    </span>
                  </div>
                ...
                <div className="health-grid">
                  <div className="health-item">
                    ...
                    <div className="health-value">
                      {formatPercentage(
                        reportData.healthIndicators?.debtToIncomeRatio
                      )}
                    </div>
                    <div className="health-bar">
                      <div
                        ...
                        style={{
                          width: `${Math.min(
                            reportData.healthIndicators?.debtToIncomeRatio || 0,
                            100
                          )}%`,
                          backgroundColor:
                            (reportData.healthIndicators?.debtToIncomeRatio ||
                  ...
                  <div className="health-item">
                    ...
                    <div className="health-value">
                      {formatPercentage(
                        reportData.healthIndicators?.savingsToIncomeRatio
                      )}
                    </div>
                    <div className="health-bar">
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor:
                            (reportData.healthIndicators
                              ?.savingsToIncomeRatio || 0) < 10
                              ? "#e74c3c"
                              : (reportData.healthIndicators
                                  ?.savingsToIncomeRatio || 0) < 20
                              ? "#f39c12"
                              : "#27ae60",
                        }}
                      ></div>
                  ...
                  <div className="health-item">
                    ...
                    <div className="health-value">
                      {(
                        reportData.healthIndicators?.emergencyFundMonths || 0
                      ).toFixed(1)}
                    </div>
                    <div className="health-bar">
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor:
                            (reportData.healthIndicators?.emergencyFundMonths ||
                              0) < 3
                              ? "#e74c3c"
                              : (reportData.healthIndicators
                  ...
                  <div className="health-item highlight">
                    ...
                    <div className="health-score-large">
                      <span
                        className={getHealthScoreColor(
                          reportData.healthIndicators?.financialHealthScore
                        )}
                      >
                        {reportData.healthIndicators?.financialHealthScore?.toFixed(
                          0
                        ) || 0}
                      </span>
              ...
              {reportData.loanSummary &&
                reportData.loanSummary.totalLoans > 0 && (
                  <section className="report-section">
                    ...
                    <div className="breakdown-list">
                      <div className="breakdown-item">
                        ...
                        <span className="breakdown-value">
                          {reportData.loanSummary.totalLoans}
                        </span>
                      </div>
                      <div className="breakdown-item">
                        <span className="breakdown-label">
                        ...
                        <span className="breakdown-value">
                          {formatCurrency(
                            reportData.loanSummary.totalOutstanding
                          )}
                        </span>
                      </div>
                      <div className="breakdown-item">
                        ...
                        <span className="breakdown-value">
                          {formatCurrency(reportData.loanSummary.totalEMI)}
                        </span>
                      </div>
                    </div>
                    {reportData.loanSummary.loansByType &&
                      reportData.loanSummary.loansByType.length > 0 && (
                        <div className="loan-types">
                          ...
                          {reportData.loanSummary.loansByType.map(
                            (loan, idx) => (
                              <div
                                key={idx}
                    ...
                    {reportData.goalProgress.map((goal, index) => (
                      <div key={index} className="goal-item">
                        <div className="goal-header">
                          <h4>{goal.goalName}</h4>
                          <span
                            className={`goal-status status-${getStatusClass(
                              goal.status
                            )}`}
                          >
                            {goal.status}
                ...
                <section className="report-section">
                  ...
                  <div className="recommendations-list">
                    {reportData.recommendations.map((rec, index) => (
                      <div
                        key={index}
                        className={`recommendation-item priority-${getPriorityClass(
                          rec.priority
                        )}`}
                      >
