                ...
                <div className="dropdown-menu-card" role="menu">
                    <div className="profile-top">
                        <div className="profile-top-left">
                            <div className="profile-avatar large">{user?.avatar ? <img src={user.avatar} alt="avatar" /> : initials}</div>
                    ...
                    <div className="menu-section">
                        <button className="menu-item" onClick={goProfile}>Profile</button>
                        <button className="menu-item" onClick={openChangePassword}>Change Password</button>
                    ...
                    {showChangeForm && (
                        <div className="change-password-form">
                            ...
                            <div className="form-actions">
                                ...
                                <button className="menu-item" onClick={closeChangePassword}>Cancel</button>
                            </div>
